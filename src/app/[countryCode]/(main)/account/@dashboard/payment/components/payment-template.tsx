                                        ...
                                        {[
                                            ...
                                            return (
                                                <motion.button
                                                    ...
                                                    className={`flex-1 px-3 py-2 border rounded text-sm font-din-arabic tracking-wide transition-all duration-200 flex items-center justify-center gap-2 whitespace-nowrap ${newPayment.type === type.value
