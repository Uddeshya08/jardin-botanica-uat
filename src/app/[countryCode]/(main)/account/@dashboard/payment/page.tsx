...
export default function PaymentPage() {
  ...
  return (
    <motion.div
      ...
      exit="exit"
    >
      <h1 className="font-american-typewriter text-2xl lg:text-3xl mb-8 lg:mb-16 text-black">Payment Methods</h1>
        ...
        >
          <div className="flex items-start mb-6 gap-12">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-din-arabic text-base text-black tracking-wide mb-1">•••• •••• •••• 4321</h3>
                <span className="font-din-arabic text-xs text-black/50 tracking-wide">Expires 12/25 • Default</span>
              </div>
            </div>
                    ...
                    {[
                      ...
                      return (
                        <motion.button
                          ...
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          onClick={() => setNewPayment({...newPayment, type: type.value as 'credit' | 'debit' | 'upi'})}
