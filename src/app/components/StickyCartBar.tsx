              ...
              {!showGoToCart ? (
                <div className="flex items-center space-x-2 md:space-x-3 flex-shrink min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="font-din-arabic-bold text-xs md:text-sm text-black/70 whitespace-nowrap mt-0.5 md:mt-0">
                      {ritualProduct && showRitualSuggestion && !showGoToCart
                    ...
                    {qualifiesShipping && (
                      <motion.p
                        ...
                        className="font-din-arabic text-[10px] md:text-xs leading-tight mt-2 md:mt-0 md:inline whitespace-nowrap"
                        style={{
