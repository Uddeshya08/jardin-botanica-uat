...
const PRIVACY_SECTIONS: PrivacySection[] = [
  {
    ...
    content:
      "Legal entity name: Jardin Botanica (OPC) Pvt. Ltd. | Brand name: Jardin Botanica | Registered address: 153, Floor 4, Zone 1, M.P. Nagar, Bhopal, M.P. 462011 | Contact email: hello@jardinbotanica.com",
  },
  {
    number: "2",
    title: "What This Policy Covers",
    content:
      "This Policy applies to: Visitors to our Site, Customers who place orders, People who sign up for our newsletter, waitlist, or updates, and People who contact us (email, forms, social).",
  },
  {
    number: "3",
    ...
    subsections: [
      {
        ...
        content:
          "Contact details: name, email, phone number | Order details: shipping address, billing address, items purchased, order notes | Account information (if you create an account): login details and preferences | Messages you send us: emails, support requests, feedback",
      },
      {
        title: "B) Information collected automatically",
        content:
          "Device + usage data: IP address, browser type, device identifiers, pages viewed, actions on the Site, approximate location (city/region) | Cookies and similar technologies",
      },
      {
        title: "C) Payment information",
        content:
          "Payments on our Site are processed by Razorpay. We do not store full card details on our servers. Razorpay may collect and process payment data directly to complete your transaction.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    content:
      "We keep personal data only as long as necessary for: Order fulfillment and customer support | Legal, tax, accounting, and compliance requirements | Security and fraud prevention | Marketing until you unsubscribe/withdraw consent (as applicable)",
  },
  {
    number: "13",
    title: "Security",
    content:
      "We implement reasonable administrative, technical, and physical safeguards designed to protect personal data. No method of transmission or storage is 100% secure, but we work to protect your information and reduce risk.",
  },
  {
    number: "14",
  ...
  },
  {
    ...
    content:
      "Our Site is not intended for children. We do not knowingly collect personal data from children. If you believe a child has provided us personal data, please contact us and we will take steps to delete it.",
  },
  {
    number: "16",
  ...
  },
  {
    ...
    content:
      "If you have questions, requests, or concerns about privacy, contact: hello@jardinbotanica.com",
    isContact: true,
  },
]
      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          <p className="font-din-arabic text-black/65 leading-relaxed text-center">
            This Privacy Policy explains how Jardin Botanica ("Jardin Botanica", "we", "us", "our")
            collects, uses, shares, and protects your personal data when you visit or make a
            purchase from our Site, or otherwise interact with us. If you do not agree with this
