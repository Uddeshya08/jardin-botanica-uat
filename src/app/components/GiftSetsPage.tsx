...
const products: Product[] = [

  {
    ...
    description: 'A complete hand care ritual featuring cleansing and nourishing botanical formulations with your choice of signature candle',

    image: 'https://images.unsplash.com/photo-1603561128891-a78e0f61a52b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBnaWZ0JTIwc2V0JTIwY2FuZGxlcyUyMGJvdGFuaWNhbHxlbnwxfHx8fDE3NjI4NDYyMzl8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    hoverImage: 'https://images.unsplash.com/photo-1580680849668-45d32df32e67?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjYW5kbGUlMjBnaWZ0JTIwc2V0JTIwbHV4dXJ5JTIwcGFja2FnaW5nfGVufDF8fHx8MTc2Mjg4MTI3MHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...

  {
    ...
    description: 'An artisan silk scarf handcrafted to elegantly wrap your gift, transforming presentation into an unforgettable experience',

    image: 'https://images.unsplash.com/photo-1759563874745-47e35c0a9572?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnaWZ0JTIwYm94JTIwaGFuZCUyMGNhcmUlMjBsdXh1cnl8ZW58MXx8fHwxNzYyODQ2MjM5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
    ...
    hoverImage: 'https://images.unsplash.com/photo-1761479258387-9542d09a5f47?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxnaWZ0JTIwYm94JTIwYm90YW5pY2FsJTIwbWluaW1hbGlzdHxlbnwxfHx8fDE3NjI4ODEyNzB8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...

  {
    ...
    description: 'Essential botanical formulations for the mindful traveler, perfectly sized for journeys near and far',

    image: 'https://images.unsplash.com/photo-1753071921478-6c160645579f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxib3RhbmljYWwlMjBnaWZ0JTIwdHJhdmVsJTIwc2V0fGVufDF8fHx8MTc2MzIyNzIwNnww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',

    hoverImage: 'https://images.unsplash.com/photo-1566977806197-b52b166f231f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBza2luY2FyZSUyMGdpZnQlMjBzZXR8ZW58MXx8fHwxNzYzMTYzODM1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...

  {
    ...
    description: 'An exploratory journey through our most celebrated botanical formulations, ideal for the curious mind',

    image: 'https://images.unsplash.com/photo-1760373071711-960143464e34?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBnaWZ0JTIwYm90YW5pY2FsJTIwZmVzdGl2ZXxlbnwxfHx8fDE3NjMyMjcyMDZ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...

  {
    ...
    description: 'A seasonal pairing of warming spice and winter botanicals, celebrating the spirit of togetherness',
...

  {
    ...
    description: 'A comprehensive skincare ritual featuring our most revered botanical formulations for radiant skin',

    image: 'https://images.unsplash.com/photo-1566977806197-b52b166f231f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsdXh1cnklMjBza2luY2FyZSUyMGdpZnQlMjBzZXR8ZW58MXx8fHwxNzYzMTYzODM1fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral',
...
export function GiftSetsPage({ onClose, onToggleLedger, ledger, onAddToCart }: GiftSetsPageProps) {
  ...
  const [selectedCandles, setSelectedCandles] = useState<{ [key: string]: string }>({});

  const [personalMessages, setPersonalMessages] = useState<{ [key: string]: string }>({});
        ...
        {filteredProducts.slice(0, 2).map((product, index) => (
          ...
          >
            ...
            <div 
              ...
              className="relative h-[60vh] lg:h-[70vh] bg-black"
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-4 sm:p-8 md:p-12 pointer-events-none">
                ...
                {product.featured && (
                  ...
                  >
                    ...
                    <span className="font-din-arabic text-white text-[10px] sm:text-xs" style={{ letterSpacing: '0.15em' }}>
                ...
                >
                  ...
                  <span className="font-din-arabic text-white text-base sm:text-lg" style={{ letterSpacing: '0.1em' }}>
                  ...
                  >
                    ...
                    <span className="font-din-arabic text-xs sm:text-sm" style={{ letterSpacing: '0.12em' }}>
                    ...
                    <div className="px-5 sm:px-8 md:px-12 pb-6 sm:pb-8 space-y-5 sm:space-y-6">
                      ...
                      {product.hasCandles && (
                        ...
                        <div className="space-y-3 pt-4 border-t border-black/10">
                          ...
                          <p className="font-din-arabic text-black/70 text-[10px] sm:text-xs" style={{ letterSpacing: '0.15em' }}>
                          ...
                          <div className="space-y-2">
                            ...
                            {candleOptions.map((candle) => (
                              ...
                              >
                                ...
                                <span className="font-din-arabic text-black/80 text-xs sm:text-sm" style={{ letterSpacing: '0.1em' }}>
                      ...
                      <div className="space-y-3 pt-4 border-t border-black/10">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          <p className="font-din-arabic text-black/50 text-[10px] sm:text-xs">
                            ...
                            {personalMessages[product.id]?.length || 0}/{product.id === 'gift-set-hand-care-ritual' ? '500' : '250'}
                        ...
                        <textarea
                          ...
                          placeholder={product.id === 'gift-set-hand-care-ritual' 
                      ...
                      >
                        ...
                        <span className="font-din-arabic text-xs sm:text-sm" style={{ letterSpacing: '0.15em' }}>
      ...
      >
        ...
        <div className="max-w-6xl w-full">
          ...
          >
            ...
            Explore our Fragrance Library — a quiet study of warm woods, resinous spices, and botanical notes.
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 sm:gap-16 lg:gap-20">
            ...
            {[

              {
                ...
                description: 'Warm, spicy, and quietly intoxicating — a blend of cracked pepper, dry sandalwood, and soft resin.'
...

              {
                ...
                description: 'Smoky oud meets cool mineral notes for a contemplative, almost meditative mood.'
...

              {
                ...
                description: 'Airy rose petals wrapped in dry cedar and a touch of resin — neither too sweet nor too crisp.'
...

              {
                ...
                description: 'Luminous jasmine infused with warm amberwood and a soft thread of saffron  Bright, warm, and quietly opulent.'
