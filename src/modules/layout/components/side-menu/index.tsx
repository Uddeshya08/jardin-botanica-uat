            ...
            <>
              <div className="relative flex h-full">
                <Popover.Button
                  ...
                  className="relative h-full flex items-center transition-all ease-out duration-200 focus:outline-none hover:font-din-arabic text-sm text-black/70 tracking-wide"
                >
                  Menu
                </Popover.Button>
              </div>
