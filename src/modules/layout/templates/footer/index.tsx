                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
                        ...
                        <div className="space-y-8 py-16 border-b-[2px] border-[#a3a37f]/30 ">
                            <div className="px-12">
                                ...
                                <div className="space-y-6">
                                    <div>
                                        ...
                                        >
                                            Inspired by the grounding aroma of a
                                            woodland trail, Cedar
                                            <br />
                                            Bloom is an earthy, botanical escape
                                            into nature's calm —
                                            <br />
                                            poured in soy wax and designed to
                                            burn slow.
                                        </p>
                                        <p
                                            style={{
                                            ...
                                            className="pb-4"
                                        >
                                            Hand-poured in small batches. Up to
                            ...
                            <div className="space-y-4 px-12 py-3">
                                ...
                                <div>
                                    <h3 style={fontStyles.description}>
                                        QUANTITY
                                    </h3>
            ...
            <div className="py-20">
                <div className="w-full">
                    <h2
                        ...
                        style={fontStyles.perfectForHeading}
                    >
                        PERFECT FOR
                    </h2>
                ...
                <div className="w-full mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[55%_45%] items-center">
                        ...
                        <div className="space-y-6 bg-[#C5C8B3] w-full h-full pl-6 lg:pl-20 pt-12">
                            <h2
                                style={fontStyles.subsequentHeading}
                                className="px-2"
                            >
                                A FOREST REBORN
                            </h2>
                            <p
                                ...
                                className="pl-2 pr-8 "
                            >
                                Crushed Pine by Jardin Botanica evokes the quiet
                                majesty of mist-covered evergreens after winter
                                rain. It is a scent of awakening—the snap of
                                pine needles beneath your feet, the crisp bite
                                of cedar carried on the wind, and the meditative
                                warmth of balsam deep in the trees. Rooted and
                                restorative, this candle celebrates the enduring
                                spirit of nature.
                            </p>
                        </div>
                    </div>
                        ...
                        {reviews.map((review, index) => (
                            <div key={index} className="">
                                ...
                                <div className="flex items-center gap-2">
                                    <h4 style={fontStyles.reviewerNama}>
                                        {review.name}
                                    </h4>
                                    <img
                                        src="/Images/tick.svg"
