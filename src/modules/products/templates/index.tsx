    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const shouldShowCart =
                scrollY > 450 &&
                (heroCartItem === null || heroCartItem.quantity > 0);
            ...
            if (
                copyrightElement &&
                copyrightElement.textContent?.includes(
                    "© 2025 Jardin Botanica",
                )
            ) {
                const copyrightRect = copyrightElement.getBoundingClientRect();
                const isFooterVisible =
                    copyrightRect.top < window.innerHeight &&
                    copyrightRect.bottom > 0;
        ...
        <>
            ...
            <div className="min-h-screen">
                ...
                <CustomerTestimonials
                    key={`customer-testimonials-${testimonialsContent?.productHandle ||
