...
export async function getProductContentByHandle(
    ...
    try {
        ...
        if (!response.items || response.items.length === 0) {
            console.warn(
                `No content found for product handle: ${productHandle}`,
            );
            return null;
        }
        ...
        return response.items
            .map((item) =>
                transformContentfulEntry(
                    item as Entry<ContentfulProductContent>,
                ),
            )
            .filter((item): item is ProductContent => item !== null);
    } catch (error) {
        console.error(
            "Error fetching all product content from Contentful:",
            error,
        );
        return [];
    }
...
function transformContentfulEntry(
    ...
    try {
        ...
        const accordionItems = fields?.productAccordion?.map(
            (details: any) => ({
                ...details.fields,
            }),
        );
...
export async function getFeaturedSectionByKey(
    ...
    try {
        ...
        const entry = response
            .items[0] as unknown as Entry<ContentfulFeaturedSection>;

        return transformFeaturedSectionEntry(entry);
    } catch (error) {
        console.error(
            "Error fetching featured section from Contentful:",
            error,
        );
        return null;
    }
...
export async function getAllFeaturedSections(): Promise<FeaturedSection[]> {
    try {
        ...
        return response.items
            .map((item) =>
                transformFeaturedSectionEntry(
                    item as unknown as Entry<ContentfulFeaturedSection>,
                ),
            )
            .filter((item): item is FeaturedSection => item !== null);
    } catch (error) {
        console.error(
            "Error fetching all featured sections from Contentful:",
            error,
        );
        return [];
    }
...
function transformFeaturedSectionEntry(
    ...
    try {
        ...
        return {
            ...
            heading:
                extractTextFromRichText(fields.heading) ||
                "Cultivate Your Ritu",
            subheading:
        ...
        console.error(
            "Error transforming Contentful featured section entry:",
            error,
        );
        return null;
    }
...
export async function getTestimonialsSectionByProductHandle(
    ...
    try {
        ...
        if (response.items && response.items.length > 0) {
            const entry = response
                .items[0] as unknown as Entry<ContentfulTestimonials>;
        ...
        console.error(
            "Error fetching testimonials section from Contentful:",
            error,
        );
        return null;
    }
...
export async function getTestimonialsSectionByKey(
    ...
    try {
        ...
        console.log(
            `Searching for testimonials section with key: ${sectionKey}`,
        );
        ...
        console.log(
            `Found ${response.items.length} testimonials entries for key: ${sectionKey}`,
        );

        if (!response.items || response.items.length === 0) {
            console.warn(
                `No testimonials section found for key: ${sectionKey}`,
            );
            return null;
        }
 ...
 */
export async function getAllTestimonialsSections(): Promise<
    TestimonialsSection[]
> {
    try {
        const client = getContentfulClient();
        ...
        return response.items
            .map((item) =>
                transformTestimonialsSectionEntry(
                    item as unknown as Entry<ContentfulTestimonials>,
                ),
            )
            .filter((item): item is TestimonialsSection => item !== null);
    } catch (error) {
        console.error(
            "Error fetching all testimonials sections from Contentful:",
            error,
        );
        return [];
    }
...
function transformTestimonialsSectionEntry(
    ...
    try {
        ...
        console.error(
            "Error transforming Contentful testimonials section entry:",
            error,
        );
        return null;
    }
...
export async function getFeaturedRitualTwoSectionByProductHandle(
    ...
    try {
        ...
        console.log(
            `Searching for featured ritual two section with productHandle: ${productHandle}`,
        );
        ...
        console.log(
            `Found ${response.items.length} entries for productHandle: ${productHandle}`,
        );

        if (response.items && response.items.length > 0) {
            const entry = response
                .items[0] as unknown as Entry<ContentfulFeaturedRitualTwo>;
            // console.log("Entry fields:", entry.fields) // Debug logging
            return transformFeaturedRitualTwoSectionEntry(entry);
        }

        console.warn(
            `No featured ritual two section found for productHandle: ${productHandle}`,
        );
        return null;
    } catch (error) {
        console.error(
            "Error fetching featured ritual two section from Contentful:",
            error,
        );
        return null;
    }
...
export async function getFeaturedRitualTwoSectionByKey(
    ...
    try {
        ...
        console.log(
            `Searching for featured ritual two section with key: ${sectionKey}`,
        );
        ...
        console.log(
            `Found ${response.items.length} entries for key: ${sectionKey}`,
        );

        if (!response.items || response.items.length === 0) {
            console.warn(
                `No featured ritual two section found for key: ${sectionKey}`,
            );
            return null;
        }
 ...
 */
export async function getAllFeaturedRitualTwoSections(): Promise<
...
> {
    try {
        ...
        console.error(
            "Error fetching all featured ritual two sections from Contentful:",
            error,
        );
        return [];
    }
...
function transformFeaturedRitualTwoSectionEntry(
    ...
    try {
        ...
        return {
            ...
            productHandle: fields.productHandle || undefined,
            heading:
                extractTextFromRichText(fields.heading) || "Hand Care Elevated",
            subheading:
                extractTextFromRichText(fields.subheading) ||
        ...
        console.error(
            "Error transforming Contentful featured ritual two section entry:",
            error,
        );
        return null;
    }
...
export async function getAfterlifeSectionByProductHandle(
    ...
    try {
        ...
        const entry = response
            .items[0] as unknown as Entry<ContentfulAfterlifeSection>;
        return transformAfterlifeSectionEntry(entry);
    } catch (error) {
        console.error(
            "Error fetching afterlife section from Contentful:",
            error,
        );
        return null;
    }
...
function transformAfterlifeSectionEntry(
    ...
    try {
        ...
        const items: AfterlifeItem[] = itemsSrc.map(
            (it: any): AfterlifeItem => {
...
export async function getProductInfoPanelsByHandle(
    ...
    try {
        ...
        const entry = response
            .items[0] as unknown as Entry<ContentfulProductInfoPanels>;
        return transformProductInfoPanelsEntry(entry);
    } catch (error) {
        console.error(
            "Error fetching product info panels from Contentful:",
            error,
        );
        return null;
    }
...
function transformProductInfoPanelsEntry(
    ...
    try {
        ...
        const actives: ActiveItem[] = activesSrc.map(
            (item: any): ActiveItem => {
                // Handle both JSON objects and stringified JSON
                const active =
        ...
        const fragranceNotesSrc = Array.isArray(fields.fragranceNotes)
            ? fields.fragranceNotes
            : [];
        const fragranceNotes: FragranceNote[] = fragranceNotesSrc.map(
            (item: any): FragranceNote => {
                // Handle both JSON objects and stringified JSON
...
export async function getFromTheLabSectionByProductHandle(
    ...
    try {
        ...
        if (response.items && response.items.length > 0) {
            const entry = response
                .items[0] as unknown as Entry<ContentfulFromTheLabSection>;
        ...
        console.error(
            "Error fetching From the Lab section from Contentful:",
            error,
        );
        return null;
    }
...
export async function getFromTheLabSectionByKey(
    ...
    try {
        ...
        if (!response.items || response.items.length === 0) {
            console.warn(
                `No From the Lab section found for key: ${sectionKey}`,
            );
            return null;
        }
...
export async function getAllFromTheLabSections(): Promise<FromTheLabSection[]> {
    try {
        ...
        console.error(
            "Error fetching all From the Lab sections from Contentful:",
            error,
        );
        return [];
    }
        ...
        const transformProductCard = (
            ...
            if (p.fields) {
                ...
                return {
                    ...
                    name: p.fields.name || "",
                    price:
                        typeof p.fields.price === "number"
                            ? p.fields.price
                            : undefined,
                    currency:
                        typeof p.fields.currency === "string"
                            ? p.fields.currency
                            : undefined,
                    image: getImageUrl(p.fields.image),
                    hoverImage: getImageUrl(p.fields.hoverImage),
                    description:
                        typeof p.fields.description === "string"
                            ? p.fields.description
                            : undefined,
                    badge:
                        typeof p.fields.badge === "string"
                            ? p.fields.badge
                            : undefined,
                    url:
                        typeof p.fields.url === "string"
                            ? p.fields.url
                            : undefined,
                    variantId:
                        typeof p.fields.variantId === "string"
                            ? p.fields.variantId
                            : undefined,
                };
            }
            ...
            if (p.sys && p.sys.type === "Link" && p.sys.linkType === "Entry") {
                console.warn(
                    "ProductCard entry not resolved, may need to check includes",
                );
                return {
                    id: p.sys.id || `product-${index}`,
                    name: "",
...
export async function getPageBanner(
    ...
    try {
        ...
        try {
            ...
            console.error(
                `[ERROR] Unknown Contentful error. Please check your Contentful configuration.`,
            );
            return null;
        }

        console.log(
            `[DEBUG] Response items count: ${response.items?.length || 0}`,
        );
            ...
            try {
                ...
                console.warn(
                    ...
                    allEntries.items.map((item: any) => ({
                        ...
                        pageKey:
                            item.fields?.pageKey ||
                            item.fields?.page_key ||
                            "NOT FOUND",
                        isActive:
                            item.fields?.isActive ??
                ...
                console.error(
                    `[DEBUG] Error fetching all entries:`,
                    debugError,
                );
            }
        ...
        const entry = response
            .items[0] as unknown as Entry<ContentfulPageBanner>;
        ...
        console.error(
            `[ERROR] Error fetching page banner for pageKey "${pageKey}" from Contentful:`,
        );
...
export async function getAllPageBanners(): Promise<PageBanner[]> {
    try {
        ...
        return response.items
            .map((item) =>
                transformPageBannerEntry(
                    item as unknown as Entry<ContentfulPageBanner>,
                ),
            )
            .filter((item): item is PageBanner => item !== null);
    } catch (error) {
        console.error(
            "Error fetching all page banners from Contentful:",
            error,
        );
        return [];
    }
...
function transformPageBannerEntry(
    ...
    try {
        ...
        console.error(
            "Error transforming Contentful page banner entry:",
            error,
        );
...
export async function getCandlesCollection(
    ...
    try {
        ...
        try {
            ...
            console.error(
                "[getCandlesCollection] Contentful API error:",
                apiError?.message,
            );
        }
        ...
        if (
            sectionResponse &&
            sectionResponse.items &&
            sectionResponse.items.length > 0
        ) {
            const section = transformCandlesCollectionSectionEntry(
                sectionResponse
                    .items[0] as unknown as Entry<ContentfulCandlesCollectionSection>,
            );
...
function transformCandlesCollectionSectionEntry(
    ...
    try {
        ...
        const items: CandlesCollectionItem[] = fields.products
            .map((product: any, index: number) => {
                ...
                if (product.fields) {
                    ...
                    const hoverImageUrl = getImageUrl(
                        product.fields.hoverImage,
                    );
                    ...
                    return {
                        label:
                            product.fields.label || product.fields.name || "",
                        src: imageUrl,
            ...
            .filter(
                (
                    item: CandlesCollectionItem | null,
                ): item is CandlesCollectionItem => item !== null,
            );
        ...
        console.error(
            "Error transforming candles collection section entry:",
            error,
        );
        return [];
    }
...
function transformCandlesCollectionItemEntry(
    ...
    try {
        ...
        if (
            ...
            console.warn(
                "[transformCandlesCollectionItemEntry] Missing image field",
            );
            return null;
        }
        ...
        if (!imageUrl) {
            console.warn(
                "[transformCandlesCollectionItemEntry] Could not extract image URL",
            );
            return null;
        }

        const hoverImageUrl = fields.hoverImage
            ? getAssetUrl(fields.hoverImage)
            : undefined;
